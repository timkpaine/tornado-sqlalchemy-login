...
# -*- coding: utf-8 -*-
#
# tornado_sqlalchemy_login documentation build configuration file, created by
...
project = 'tornado_sqlalchemy_login'
...
_version_py = os.path.join('..', 'tornado_sqlalchemy_login', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'tornado_sqlalchemy_logindoc'
...
latex_documents = [
    (master_doc, 'tornado_sqlalchemy_login.tex', 'tornado_sqlalchemy_login Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'tornado_sqlalchemy_login', 'tornado_sqlalchemy_login Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tornado_sqlalchemy_login', 'tornado_sqlalchemy_login Documentation',
     author, 'tornado_sqlalchemy_login', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    tornado_sqlalchemy_login_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'tornado_sqlalchemy_login'))
